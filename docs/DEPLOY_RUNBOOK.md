...
| `scripts/validate-against-sheet.mjs`                          | Blocked on the owner's spreadsheet export (`docs/archive/PHASE2_PLAN.md` tracks it as ⏳). Run it by hand against a CSV; it exits non-zero with a usage error when given no input.                                                                                                                                                |
