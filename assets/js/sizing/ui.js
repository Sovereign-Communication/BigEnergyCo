...
import { CITY_PRESETS, } from "./nasa.js?v=20260825p";

import { estimateTariff, battOnlyCost, CURRENCIES, fxMeta } from "./pricing.js?v=20260825p";

import { BOM_ITEMS } from "../shared/content.js?v=20260825p";

import { applyI18n, initLangPicker } from "../shared/i18n.js?v=20260825p";

import { LOCALES } from "../shared/locales.js?v=20260825p";
...
function ensureWorker() {
  ...
  if (!worker) {
    ...
    worker = new Worker("./assets/js/sizing/sizing-worker.js?v=20260825p", { type: "module" });
