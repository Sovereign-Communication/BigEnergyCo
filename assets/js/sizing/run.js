...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260920a";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260920a";
import { buildFrontier } from "./frontier.js?v=20260920a";
import { oversizeCallout } from "./rescale.js?v=20260920a";
import { climateSummary } from "./climate.js?v=20260920a";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260920a");
    let best = null,
      bestD = Infinity;
