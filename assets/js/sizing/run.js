...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260906i";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260906i";
import { buildFrontier } from "./frontier.js?v=20260906i";
import { oversizeCallout } from "./rescale.js?v=20260906i";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260906i");
    let best = null,
      bestD = Infinity;
