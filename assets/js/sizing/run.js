...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260906l";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260906l";
import { buildFrontier } from "./frontier.js?v=20260906l";
import { oversizeCallout } from "./rescale.js?v=20260906l";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260906l");
    let best = null,
      bestD = Infinity;
