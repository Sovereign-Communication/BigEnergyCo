...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260906o";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260906o";
import { buildFrontier } from "./frontier.js?v=20260906o";
import { oversizeCallout } from "./rescale.js?v=20260906o";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260906o");
    let best = null,
      bestD = Infinity;
