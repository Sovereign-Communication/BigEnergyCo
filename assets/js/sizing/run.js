...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260917h";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260917h";
import { buildFrontier } from "./frontier.js?v=20260917h";
import { oversizeCallout } from "./rescale.js?v=20260917h";
import { climateSummary } from "./climate.js?v=20260917h";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260917h");
    let best = null,
      bestD = Infinity;
