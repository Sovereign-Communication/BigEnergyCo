...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260911b";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260911b";
import { buildFrontier } from "./frontier.js?v=20260911b";
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260911b");
    let best = null,
      bestD = Infinity;
