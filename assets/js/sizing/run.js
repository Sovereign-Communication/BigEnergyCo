...
} from "./nasa.js?v=20260908a";
import { buildFrontier } from "./frontier.js?v=20260908a";
import { oversizeCallout } from "./rescale.js?v=20260908a";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260908a");
    let best = null,
      bestD = Infinity;
