...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260919c";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260919c";
import { buildFrontier } from "./frontier.js?v=20260919c";
import { oversizeCallout } from "./rescale.js?v=20260919c";
import { climateSummary } from "./climate.js?v=20260919c";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260919c");
    let best = null,
      bestD = Infinity;
