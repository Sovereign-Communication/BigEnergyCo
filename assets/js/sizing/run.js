...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260911c";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260911c";
import { buildFrontier } from "./frontier.js?v=20260911c";
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260911c");
    let best = null,
      bestD = Infinity;
