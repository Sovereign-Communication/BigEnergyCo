...
import {
  ...
  billCutFraction,
} from "./engine.js?v=20260921f";

import {
  fetchHourlyCached,
  synthesizeFromProfile,
} from "./nasa.js?v=20260921f";
import { buildFrontier } from "./frontier.js?v=20260921f";
import { oversizeCallout } from "./rescale.js?v=20260921f";
import { climateSummary } from "./climate.js?v=20260921f";
import {
  fullRange,
  getScope,
  POWMR_CATALOG,
...
async function fetchWeatherWithFallback(opts) {
  try {
    ...
    const { OFFLINE_PROFILES, PROFILE_YEAR } =
      await import("./profiles.js?v=20260921f");
    let best = null,
      bestD = Infinity;
