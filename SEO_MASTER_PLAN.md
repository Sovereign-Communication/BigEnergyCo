...
*Metric: all pages indexed, zero coverage errors.*
...
*Metric: impressions up on "off grid calculator" cluster; first page-10 rankings.*

**Phase 3 (months 2–4): programmatic scale.** Ship `/solar-calculator/{city}/` (66 cities) + hub page. Show HN launch.
*Metric: long-tail impressions ("solar calculator [city]"), 20+ pages with traffic.*
...
*Metric: top-10 for 5+ head terms ("off grid solar calculator", "is a home battery worth it").*
