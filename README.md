...
| `docs/plan/MASTER_PLAN.md`                | **The** plan: immutable (hash-pinned, `npm run plan:check`), amended only via `docs/plan/AMENDMENTS.md`; progress in `docs/plan/LEDGER.jsonl`. Supersedes the plan docs below                |
| `PLAN.md`                                 | Roadmap                                                                                                                                                                                      |
