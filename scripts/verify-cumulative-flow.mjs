...
const hours = Array.from({ length: 24 * 365 }, (_, i) => ({ ghi: 1000, tAmb: 25 }));
const fetchWeather = async () => ({ hours, meta: { latitude: 21.3, longitude: -157.8, startYear: 2024, endYear: 2024, years: 1, source: "headless verification", offline: false } });

const payload = await runSizing({ latitude: 21.3, longitude: -157.8, years: 1, dailyKwh: 2, chemistry: "lfp", mode: "gridtie", tariff: 0.42, exportRate: null, autoTier: "tier99", autoTargetId: "cut80" }, { fetchWeather });
