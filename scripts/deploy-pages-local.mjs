...
const allowedTop = new Set(["index.html", "404.html", "robots.txt", "sitemap.xml", "rss.xml", "sw.js", "manifest.webmanifest", "_headers", "_redirects", "blog", "solar-calculator", "assets"]);
